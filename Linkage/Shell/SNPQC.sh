...
##  Sample IDs have been removed here ####
...
## Removed manual update of one pedigree
...
Rscript: MERLIN_ERROR_V2.R
    ...
    dev.off()
## Removed maker info tabled by indvidual pedigree
...
## Removed labelling od combined pedigree
